...
**No LLM, coding agent, vibe, or other "AI" crap was or ever will be used in this project.**
...
### Navigating files
As the first line hints at, pressing the `N` and `P` keys will move the next and previous file in the listing.  
